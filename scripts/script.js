...
function compileContent() {
    var a = "moc.liamg/rotiaborotciv".split("").reverse().join("").replace("/", "@");
    var b = {
        name: "Victor Obaitor",
        title: "Software Developer",
        work: {
            position: ["UI/UX", "Developer", "Data Nerd"],
            company: '<a href="http://neuronah.com">Neuronah</a>',
            location: "Lagos, Nigeria"
        },
        interests: {
            type: "Books Video Games",
            portfolio: '<a href="http://viiic.azurewebsites.net/portfolio">http://viiic.azurewebsites.net/</a>'
        },
        contact: ['<a class="item" href="mailto:' + a + '">' + a + "</a>", '<a class="item" href="http://ng.linkedin.com/in/vobaitor">LinkedIn</a>', '<a class="item" href="https://twitter.com/vics_linq">twitter</a>']
    };
